...
library(pdist)
source('./../../Meng2020/get_inner.R')
source('./../../Meng2020/W.gen.R')
source('./../../Meng2020/getInner.R')
source('./../../Meng2020/getInner.itrfit.dif.R')
source('./../../Meng2020/pred.R')
source('./../../Meng2020/itrFit.R')
source('./../../Meng2020/predict.itrfit.R')
sourceCpp('./../../Meng2020/diffit_C.cpp')
