...
tune_knn = function(x_train,y_train,x_tune,y_tune,x_threshold=x_tune,y_threshold=y_tune,x_test,y_test,r,r_match,k_pool = c(5,10,20)) {
  ...
  threshold_robust = rep(0,class_number) 
